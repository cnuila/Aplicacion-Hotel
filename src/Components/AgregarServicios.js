                ...
                <div className="grid min-h-screen place-items-center">
                    <div className="w-3/4 p-12 bg-white">
                        ...
                        <form className="mt-6">                       
                            ...
                            <input type="text" onChange={this.handleNombre} name="nombre" placeholder="Salón de eventos" className="block w-full p-3 mt-2 text-gray-700 bg-gray-200 appearance-none focus:outline-none focus:bg-gray-300 focus:shadow-inner" required />
                            <label className="block mt-2 text-sm font-semibold text-gray-600 uppercase">Precio del servicio</label>
                            <input type="number" onChange={this.handlePrecio} name="Precio" placeholder="Lps.1500" className="block w-full p-3 mt-2 text-gray-700 bg-gray-200 appearance-none focus:outline-none focus:bg-gray-300 focus:shadow-inner" required />
                            <label className="block mt-8 text-sm font-semibold text-gray-600 uppercase">Detalles</label>
                            <input type="text" value={this.state.elemento} onChange={this.handleDetalles} name="Detalles" placeholder="Incluye decoraciones" className="block w-full p-3 mt-2 text-gray-700 bg-gray-200 appearance-none focus:outline-none focus:bg-gray-300 focus:shadow-inner"/>
                            ...
                            <input type="submit" value="Agregar Servicio" onClick={this.handleAgregarServicios} className="w-full py-3 mt-10 font-medium tracking-widest text-white uppercase bg-black shadow-lg focus:outline-none hover:bg-gray-900 hover:shadow-none" />
