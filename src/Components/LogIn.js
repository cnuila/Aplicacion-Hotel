...
export default function LogIn() {
    ...
    const authEmail = () => {
        //Implementar autenticacion por correo
    }
                ...
                <div className="grid min-h-screen place-items-center" >
                    ...
                    <div className="w-11/12 p-12 bg-white sm:w-8/12 md:w-1/2 lg:w-6/12">
                        ...
                        <div className="grid grid-cols-2 mt-4 place-items-center">
                            <div className="flex col-span-2 lg:col-span-1 bg-black hover:bg-gray-900 m-3 h-12 w-56 items-center shadow-lg rounded cursor-pointer" onClick={authEmail}>
                                <div className="mx-1 text-center w-full text-sm font-semibold text-white text-opacity-90">
                                    Iniciar Sesión
                                </div>
                            </div>
