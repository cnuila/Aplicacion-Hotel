...
const Navbar = () =>{
    return(
        <div class="lg:px-16 px-6 bg-white flex flex-wrap items-center lg:py-0 py-2">
            <div clas="flex-1 flex justify-between items-center">
                <a href="#">Home</a>
                ...
                <div class="hidden lg:flex lg:items-center lg:w-auto w-full" id="menu">
                    ...
                    <a href="#" class="lg:ml-4 flex items-center justify-start lg:mb-0 mb-4 cursor-pointer">
                        <img src="" class="rounded-full w-10 h-10 border-2 border-transparent hover:border-indigo-400" alt="Image"></img>
                    </a>
                </div>
            </div>
        </div>
