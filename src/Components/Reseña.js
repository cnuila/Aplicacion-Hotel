    ...
    return (
        <div className="grid grid-cols-1 gap-1">
            <div className="flex justify-center container w-full mx-auto py-2 px-1">
                <div className="  flex justify-center w-4/6  bg-gray-300 rounded-3xl border-blue-900 border shadow-lg  lg:pb-0">
                    <div className="w-full  p-4">
                        <div className="justify-items-center ">
                            <div className="grid grid-cols-2">
                                <h3 className="text-blue mx-7 font-semibold text-lg text-center md:text-left ">{resena.usuario}</h3>
