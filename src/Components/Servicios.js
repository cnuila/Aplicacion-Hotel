    ...
    render(){
        return (
            ...
            <div class="space-y-4 divide-y-2 divide-gray-400">
                <div class="grid grid-cols-1 sm:grid-cols-2 sm:px-8 sm:py-12 sm:gap-x-8 md:py-16 bg-local bg-gray-900">

                    <div class="relative z-10 col-start-1 row-start-1 px-4 pt-40 pb-3 bg-gradient-to-t from-black sm:bg-none">
                        <p class="text-sm font-medium text-white sm:mb-1 sm:text-whitee">Habitaciones</p>
                    ...
                    <div class="col-start-1 row-start-2 px-4 sm:pb-16 bg-none">
                        <div class="flex items-center text-sm font-medium my-5 sm:mt-2 sm:mb-4 text-white">
