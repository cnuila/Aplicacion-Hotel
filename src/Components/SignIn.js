                            ...
                            <form class="mt-6">
                                <div class="flex justify-between gap-3">
                                    <span class="w-1/2">
                                        ...
                                        <input id="Nombre" type="text" onChange={this.handleInputChange} name="Nombre" placeholder="Juan" autocomplete="given-name" class="block w-full p-3 mt-2 text-gray-700 bg-gray-200 appearance-none focus:outline-none focus:bg-gray-300 focus:shadow-inner" required />
                                    </span>
                                    <span class="w-1/2">
                                        <label for="Apellido" class="block text-xs font-semibold text-gray-600 uppercase">Apellido</label>
                                        <input id="Apellido" type="text" onChange={this.handleInputChange} name="Apellido" placeholder="Perez" autocomplete="family-name" class="block w-full p-3 mt-2 text-gray-700 bg-gray-200 appearance-none focus:outline-none focus:bg-gray-300 focus:shadow-inner" required />
                                    </span>
                                ...
                                <input id="email" type="email" name="email" onChange={this.handleInputChange} placeholder="john.doe@company.com" autocomplete="email" class="block w-full p-3 mt-2 text-gray-700 bg-gray-200 appearance-none focus:outline-none focus:bg-gray-300 focus:shadow-inner" required />
                                <label for="password" class="block mt-2 text-xs font-semibold text-gray-600 uppercase">Contraseña</label>
                                <input id="password" type="password" name="password" onChange={this.handleInputChange} placeholder="********" autocomplete="new-password" class="block w-full p-3 mt-2 text-gray-700 bg-gray-200 appearance-none focus:outline-none focus:bg-gray-300 focus:shadow-inner" required />
